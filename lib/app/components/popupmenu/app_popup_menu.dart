// Override popup_menu flutter built-in
...
const double _kMenuWidthStep = 70.0;
...
class CheckedPopupMenuItem<T> extends AppPopupMenuItem<T> {
  ...
  /// [ListTile.leading] slot is an [Icons.tick] icon.
  @override
        ...
        builder: (BuildContext context) {
          return CustomSingleChildLayout(
            ...
            child: ShadowStrokeStyles(
                shadowStrokeType: ShadowStrokeType.medShadow, child: menu),
          );
        },
      ),
    );
...
Future<T> showAppPopupMenu<T>(
  ...
  return await showMenu<T>(
    ...
    position: RelativeRect.fromLTRB(
        ...
        tapUpDetails.globalPosition.dy - kDefaultMargin * 6,
        kDefaultMargin + kDefaultTinyMargin,
        0),
    shape: const RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(kBorderRadiusExtraSmall)),
    ),
    items: items,
    elevation: 0.0,
  );
