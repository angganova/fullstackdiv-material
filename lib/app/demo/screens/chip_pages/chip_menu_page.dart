          ...
          children: <Widget>[
            ...
            Expanded(
              child: BasicGridViewCount(
                ...
                crossAxisCount: 2,
                children:
                    List<Widget>.generate(chipControllers.length, (int index) {
                  return BasicWideCard(
                    image: placeholderAssetImage,
                    title: chipControllers[index].title,
                    subtitle: chipControllers[index].subtitle,
                    onCardTap: () => ExtendedNavigator.of(context)
                        .push(chipControllers[index].child),
                  );
                }),
              ),
            ),
