          ...
          children: <Widget>[
            ...
            Expanded(
              child: BasicGridViewCount(
                ...
                crossAxisCount: 2,
                children: List<Widget>.generate(shimmerDemoCardList.length,
                    (int index) {
                  return BasicWideCard(
                    image: placeholderAssetImage,
                    title: shimmerDemoCardList[index].title,
                    subtitle: shimmerDemoCardList[index].subtitle,
                    onCardTap: () => ExtendedNavigator.of(context)
                        .push(shimmerDemoCardList[index].route),
                  );
                }),
              ),
            ),
