          ...
          children: <Widget>[
            ...
            Expanded(
              child: BasicGridViewCount(
                ...
                crossAxisCount: 2,
                children: List<Widget>.generate(bottomNavDemoCardList.length,
                    (int index) {
                  return BasicWideCard(
                    image: placeholderAssetImage,
                    title: bottomNavDemoCardList[index].title,
                    subtitle: bottomNavDemoCardList[index].subtitle,
                    onCardTap: () => ExtendedNavigator.of(context)
                        .push(bottomNavDemoCardList[index].route),
                  );
                }),
              ),
            ),
