          ...
          children: <Widget>[
            ...
            Expanded(
              child: BasicGridViewCount(
                ...
                crossAxisCount: 2,
                children: List<Widget>.generate(optionControllers.length,
                    (int index) {
                  return BasicWideCard(
                    image: placeholderAssetImage,
                    title: optionControllers[index].title,
                    subtitle: optionControllers[index].subtitle,
                    onCardTap: () => ExtendedNavigator.of(context)
                        .push(optionControllers[index].child),
                  );
                }),
              ),
            ),
